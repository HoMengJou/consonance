...
#pleasantness ratings/diotic as as example
...
#pleasantness ratings/melodic intervals as as example
#calculate correlation coefficient 
...
#pleasantness ratings/harmonic intervals/diotic as example
#calculate correlation coefficient 
